...
[x] Prepare the main denormalized dataset (Joins: results, drivers, constructors, races).

[x] Calculate the total team points for every race (Window Function).
...
Define a scoring formula, for example: Total Score = (Dominance * 100) + (Avg Positions Gained * 2).
